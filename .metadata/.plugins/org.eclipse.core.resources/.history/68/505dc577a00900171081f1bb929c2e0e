...
<body>
	...
	<div style="margin: 15px auto;">
		<!-- 搜索表单 -->
		<s:form action="TopicAction_list" namespace="/" theme="simple"
			cssClass="simpleSearchForm">
		...
		<tbody class="list topicList">
			...
			<s:iterator value="#list" var="topic">
				...
				<tr class="data">
					...
					<td class="info"><s:date name="createDate"
			...
			<tr>
				<td colspan="5" class="num">共有主题数<font color="red"><s:property
							value="#list.size" /> </font>个
				</td>
			</tr>
		</tbody>
	</table>
	...
	<s:form action="TopicAction_add" namespace="/" theme="simple"
		...
		<table class="publishArticleForm">
			<tr>
				<td>标 题:</td>
				<td><s:textfield name="topic.title" cssClass="title"></s:textfield>
				</td>
			</tr>
			<tr>
				<td>内 容:</td>
				<td><s:textarea name="topic.topicContent" cssClass="content"></s:textarea>
				</td>
			</tr>
			<tr>
				<td></td>
